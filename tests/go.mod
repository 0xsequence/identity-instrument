module github.com/0xsequence/identity-instrument/tests

go 1.25.3

replace github.com/0xsequence/identity-instrument => ../

require (
	github.com/0xsequence/ethkit v1.38.6
	github.com/0xsequence/identity-instrument v0.0.0
...
require (
	...
	github.com/0xsequence/nitrocontrol v0.9.0 // indirect
	...
	github.com/webrpc/webrpc v0.31.2 // indirect
