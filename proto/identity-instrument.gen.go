...
func WebRPCSchemaHash() string {
	return "971b635a03efb658010d40cfdade0f698c3f3c56"
}
...
type IdentityInstrument interface {
	InitiateAuth(ctx context.Context, params *InitiateAuthParams) (string, string, error)
	RegisterAuth(ctx context.Context, params *RegisterAuthParams) (string, error)
...
func (s *identityInstrumentServer) serveInitiateAuthJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	ret0, ret1, err := s.IdentityInstrument.InitiateAuth(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (c *identityInstrumentClient) InitiateAuth(ctx context.Context, params *InitiateAuthParams) (string, string, error) {
	in := struct {
		Arg0 *InitiateAuthParams `json:"params"`
	}{params}
	out := struct {
...
func (c *identityInstrumentClient) RegisterAuth(ctx context.Context, params *RegisterAuthParams) (string, error) {
	in := struct {
		Arg0 *RegisterAuthParams `json:"params"`
	}{params}
	out := struct {
