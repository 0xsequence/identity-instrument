// identity-instrument v0.1.0 e9865a154e6613558d073b682c875045b6a24fd1
// --
// Code generated by webrpc-gen@v0.22.1 with golang generator. DO NOT EDIT.
//
// webrpc-gen -schema=nitro.ridl -target=golang -pkg=proto -server -client -out=./nitro.gen.go
package proto
...
const WebrpcHeaderValue = "webrpc@v0.22.1;gen-golang@v0.17.0;identity-instrument@v0.1.0"
...
func WebRPCSchemaHash() string {
	return "e9865a154e6613558d073b682c875045b6a24fd1"
}
...
type Attestation struct {
	IdentityType IdentityType `json:"identityType" abi:"bytes4"`
	IssuerHash   common.Hash  `json:"issuerHash" abi:"bytes32"`
	AudienceHash common.Hash  `json:"audienceHash" abi:"bytes32"`
	AuthData     []byte       `json:"authData" abi:"bytes"`
	ExtraData    []byte       `json:"extraData" abi:"bytes"`
}

type InitiateAuthParams struct {
...
var methods = map[string]method{
	"/rpc/IdentityInstrument/InitiateAuth": {
		Name:        "InitiateAuth",
		Service:     "IdentityInstrument",
		Annotations: map[string]string{},
	},
	"/rpc/IdentityInstrument/RegisterAuth": {
		Name:        "RegisterAuth",
		Service:     "IdentityInstrument",
		Annotations: map[string]string{},
	},
...
type IdentityInstrument interface {
	InitiateAuth(ctx context.Context, params *InitiateAuthParams) (*InitiateAuthResponse, error)
	RegisterAuth(ctx context.Context, params *RegisterAuthParams) (*RegisterAuthResponse, error)
	Sign(ctx context.Context, params *SignParams) (*SignResponse, error)
}
...
func (s *identityInstrumentServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	switch r.URL.Path {
	case "/rpc/IdentityInstrument/InitiateAuth":
		handler = s.serveInitiateAuthJSON
	case "/rpc/IdentityInstrument/RegisterAuth":
		handler = s.serveRegisterAuthJSON
...
func (s *identityInstrumentServer) serveInitiateAuthJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	reqPayload := struct {
		Arg0 *InitiateAuthParams `json:"params"`
	}{}
	...
	ret0, err := s.IdentityInstrument.InitiateAuth(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
	...
	respPayload := struct {
		Ret0 *InitiateAuthResponse `json:"res"`
	}{ret0}
...
func (s *identityInstrumentServer) serveRegisterAuthJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "RegisterAuth")
	...
	reqPayload := struct {
		Arg0 *RegisterAuthParams `json:"params"`
	}{}
	if err := json.Unmarshal(reqBody, &reqPayload); err != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadRequest.WithCausef("failed to unmarshal request data: %w", err))
		return
	...
	// Call service method implementation.
	ret0, err := s.IdentityInstrument.RegisterAuth(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
	...
	respPayload := struct {
		Ret0 *RegisterAuthResponse `json:"res"`
	}{ret0}
	respBody, err := json.Marshal(respPayload)
	if err != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadResponse.WithCausef("failed to marshal json response: %w", err))
...
func (c *identityInstrumentClient) InitiateAuth(ctx context.Context, params *InitiateAuthParams) (*InitiateAuthResponse, error) {
	in := struct {
		Arg0 *InitiateAuthParams `json:"params"`
	}{params}
	out := struct {
...
func (c *identityInstrumentClient) RegisterAuth(ctx context.Context, params *RegisterAuthParams) (*RegisterAuthResponse, error) {
	in := struct {
		Arg0 *RegisterAuthParams `json:"params"`
	}{params}
	out := struct {
...
func (c *identityInstrumentClient) Sign(ctx context.Context, params *SignParams) (*SignResponse, error) {
	in := struct {
		Arg0 *SignParams `json:"params"`
	}{params}
	out := struct {
