...
func WebRPCSchemaHash() string {
	return "4e9ac0518691855f457e1cc5ac4e15421325c8a0"
}
...
type IdentityInstrument interface {
	InitiateAuth(ctx context.Context, params *InitiateAuthParams) (string, error)
...
func (c *identityInstrumentClient) InitiateAuth(ctx context.Context, params *InitiateAuthParams) (string, error) {
	in := struct {
		Arg0 *InitiateAuthParams `json:"params"`
	}{params}
	out := struct {
