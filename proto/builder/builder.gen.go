//	d07f0bb3bd335926a58e28d79a4efa603d181bff
//
// --
...
const WebrpcHeaderValue = "webrpc@v0.23.1;gen-golang@v0.17.0;@v0.0.0-d07f0bb3bd335926a58e28d79a4efa603d181bff"
...
func WebRPCSchemaHash() string {
	return "d07f0bb3bd335926a58e28d79a4efa603d181bff"
}
...
const (
	...
	TemplateType_LOGIN   TemplateType = 1
	TemplateType_GUARD   TemplateType = 2
)

var TemplateType_name = map[uint8]string{
	0: "UNKNOWN",
	1: "LOGIN",
	2: "GUARD",
}

var TemplateType_value = map[string]uint8{
	"UNKNOWN": 0,
	"LOGIN":   1,
	"GUARD":   2,
}
...
func (x TemplateType) String() string {
	return TemplateType_name[uint8(x)]
}

func (x TemplateType) MarshalText() ([]byte, error) {
	return []byte(TemplateType_name[uint8(x)]), nil
}

func (x *TemplateType) UnmarshalText(b []byte) error {
	*x = TemplateType(TemplateType_value[string(b)])
	return nil
}

func (x *TemplateType) Is(values ...TemplateType) bool {
	if x == nil {
		return false
	}
...
type EcosystemTemplate struct {
	...
	SESSettings  *SESSettings `json:"sesSettings" db:"ses_settings"`
...
var methods = map[string]method{
	"/rpc/EcosystemManager/GetTemplate": {
		Name:        "GetTemplate",
...
type EcosystemManager interface {
	GetTemplate(ctx context.Context, ecosystemId uint64, templateType TemplateType) (*EcosystemTemplate, error)
}
...
type ecosystemManagerServer struct {
	EcosystemManager
	OnError   func(r *http.Request, rpcErr *WebRPCError)
	OnRequest func(w http.ResponseWriter, r *http.Request) error
}

func NewEcosystemManagerServer(svc EcosystemManager) *ecosystemManagerServer {
	return &ecosystemManagerServer{
		EcosystemManager: svc,
	}
}

func (s *ecosystemManagerServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	defer func() {
	...
	ctx = context.WithValue(ctx, ServiceNameCtxKey, "EcosystemManager")

	r = r.WithContext(ctx)

	var handler func(ctx context.Context, w http.ResponseWriter, r *http.Request)
	switch r.URL.Path {
	case "/rpc/EcosystemManager/GetTemplate":
		handler = s.serveGetTemplateJSON
	default:
...
func (s *ecosystemManagerServer) serveGetTemplateJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetTemplate")
	...
	reqPayload := struct {
		...
		Arg1 TemplateType `json:"templateType"`
	}{}
	...
	ret0, err := s.EcosystemManager.GetTemplate(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
	...
	respPayload := struct {
		Ret0 *EcosystemTemplate `json:"template"`
	}{ret0}
...
func (s *ecosystemManagerServer) sendErrorJSON(w http.ResponseWriter, r *http.Request, rpcErr WebRPCError) {
	if s.OnError != nil {
		s.OnError(r, &rpcErr)
	}
...
func (c *ecosystemManagerClient) GetTemplate(ctx context.Context, ecosystemId uint64, templateType TemplateType) (*EcosystemTemplate, error) {
	in := struct {
		Arg0 uint64       `json:"ecosystemId"`
		Arg1 TemplateType `json:"templateType"`
	}{ecosystemId, templateType}
	out := struct {
		Ret0 *EcosystemTemplate `json:"template"`
	}{}
